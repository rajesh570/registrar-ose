...
RUN curl -O http://jenkins-registrar.dev-prsn.com:8080/view/PaaS%20POC/job/openshift-deploy-singleService/lastSuccessfulBuild/artifact/service/target/registrar-jar-with-dependencies.jar
...
ENV SERVERS "java -classpath registrar-jar-with-dependencies.jar com.pearson.grid.registrar.Main"
